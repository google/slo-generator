...
"""
`custom_stackdriver.py`
Dummy sample of a custom expoter.
In this case it's the copy of slo_generator.exporters.stackdriver.py
"""
import logging
...
class CustomeStackdriverExporter:
