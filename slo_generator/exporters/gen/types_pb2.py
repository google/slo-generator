...
_EXEMPLAR = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='labels', full_name='prometheus.Exemplar.labels', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='value', full_name='prometheus.Exemplar.value', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='timestamp', full_name='prometheus.Exemplar.timestamp', index=2,
